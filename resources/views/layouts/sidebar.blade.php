<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <div class="app-brand demo ps-4">
    <a href="index.html" class="app-brand-link">
      <span class="app-brand-logo demo">
        <img src="{{ asset('images/logolecturna.png')}}" alt="logo" height="45px" width="45px">
      </span>
      <span class="app-brand-text demo menu-text fw-bold ms-2">Lecturna</span>
    </a>
