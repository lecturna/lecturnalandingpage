...
// ================= tambahan ==========================
		...
		const menuItems = document.querySelectorAll('.js-clone-nav li');
		...
		menuItems.forEach(menuItem => {
			menuItem.addEventListener('click', function(event) {
				...
				menuItem.parentNode.querySelectorAll('li.active').forEach(sibling => {
				sibling.classList.remove('active');
				});

				// Add "active" class to the clicked item or its parent if it has children
		...
		const sections = document.querySelectorAll(".section_scrolling");
			const navLi = document.querySelectorAll(".site-navigation ul li");
			window.onscroll = () => {
			var current = "";
